<?php
class HausDesign_View_Helper_TinyMce extends Zend_View_Helper_Abstract
{
    ...
    {
        $script = $this->view->baseUrl() . '/scripts/tinymce/jscripts/tiny_mce/jquery.tinymce.js';
    ...
    {
        $script  = '$(' . $id . ').tinymce({' . PHP_EOL;
        $script .= '    script_url : \'' . $this->view->baseUrl() . '/scripts/tinymce/jscripts/tiny_mce/tiny_mce.js\',';
