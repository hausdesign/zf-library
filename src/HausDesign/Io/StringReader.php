...
/**
 * The HausDesign_Io_StringReader represents a character stream whose source is
 * a string.
 *
 * @category   Zend
 * @package    HausDesign_Io
 ...
 * @version    $Id: StringReader.php 177 2010-03-09 13:13:34Z svollbehr $
 */
class HausDesign_Io_StringReader extends HausDesign_Io_Reader
{
    /**
     * Constructs the HausDesign_Io_StringReader class with given source string.
     *
    ...
    public function __construct($data, $length = null)
    {
        if (($this->_fd = fopen('php://memory', 'w+b')) === false) {
            ...
            throw new HausDesign_Io_Exception('Unable to open php://memory stream');
        }
