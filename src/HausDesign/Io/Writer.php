...
/**
 * The HausDesign_Io_Writer class represents a character stream providing means to
...
class HausDesign_Io_Writer
{
    ...
    /**
     * Constructs the HausDesign_Io_Writer class with given open file descriptor.
     *
     * @param resource $fd The file descriptor.
     * @throws HausDesign_Io_Exception if file descriptor is not valid
     */
     ...
     *
     * @return integer
     * @throws HausDesign_Io_Exception if the stream is closed
     */
