 ...
 * @version    $Id: Container.php 177 2010-03-09 13:13:34Z svollbehr $
 */
abstract class HausDesign_Media_Asf_Object_Container extends HausDesign_Media_Asf_Object
{
    /** @var Array */
    ...
    protected final function constructObjects($defaultclassnames = array())
    {
        while (true) {
            ...
            if (isset($defaultclassnames[$guid])) {
                if (@fopen($filename = 'HausDesign/Media/Asf/Object/' .
                           $defaultclassnames[$guid] . '.php',
                           'r', true) !== false) {
                    require_once($filename);
                }
                if (class_exists
                    ($classname = 'HausDesign_Media_Asf_Object_' .
                     $defaultclassnames[$guid])) {
                    $object = new $classname($this->_reader, $this->_options);
                 } else {
                    require_once 'HausDesign/Media/Asf/Object/Unknown.php';
                    $object = new HausDesign_Media_Asf_Object_Unknown
    ...
    public function __get($name)
    {
        ...
        if (defined($constname = get_class($this) . '::' . strtoupper
            ...
            if (isset($objects[0])) {
                ...
                if (class_exists
                    ($classname = 'HausDesign_Media_Asf_Object_' . ucfirst($name))) {
                    $obj = new $classname();
        ...
        throw new HausDesign_Media_Asf_Exception('Unknown field/object: ' . $name);
    }
    ...
    public function __set($name, $value)
    {
        ...
        if (defined($constname = get_class($this) . '::' . strtoupper
            ...
            require_once 'HausDesign/Media/Asf/Exception.php';
            throw new HausDesign_Media_Asf_Exception
