...
/**#@+ @ignore */
require_once 'HausDesign/Media/Asf/Object.php';
/**#@-*/
 ...
 * {@link HausDesign_Media_Asf_Object_TimecodeIndexParameters Timecode Index
 *  Parameters Object} must have timecode Payload Extension Systems associated
 * with them in the
 * {@link HausDesign_Media_Asf_Object_ExtendedStreamProperties Extended Stream
 *  Properties Object}. This object shall be present in the
 * {@link HausDesign_Media_Asf_Object_Header Header Object} if there is a
 * {@link HausDesign_Media_Asf_Object_TimecodeIndex Timecode Index Object} present in
 * the file.
 *
 * An Index Specifier is required for each stream that will be indexed by the
 * {@link HausDesign_Media_Asf_Object_TimecodeIndex Timecode Index Object}. These
 * specifiers must exactly match those in the
 * {@link HausDesign_Media_Asf_Object_TimecodeIndex Timecode Index Object}.
 *
 * @category   Zend
 * @package    HausDesign_Media
 * @subpackage ASF
 ...
 * @version    $Id: TimecodeIndexParameters.php 177 2010-03-09 13:13:34Z svollbehr $
 */
final class HausDesign_Media_Asf_Object_TimecodeIndexParameters
    extends HausDesign_Media_Asf_Object
{
    /** @var string */
    ...
    public function write($writer)
    {
        ...
        throw new HausDesign_Media_Asf_Exception('Operation not supported');
    }
}
