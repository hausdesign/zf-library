 ...
 * @version    $Id: Object.php 177 2010-03-09 13:13:34Z svollbehr $
 */
abstract class HausDesign_Media_Mpeg_Object
{
    /**
     * The reader object.
     *
    ...
    protected final function nextStartCode()
    {
        ...
        for ($i = 0; $i < 4; $i++) {
            ...
            if (($buffer = substr($buffer, -4) .
                ...
                throw new HausDesign_Media_Mpeg_Exception('Invalid data');
            }
            $limit = strlen($buffer);
            $pos = 0;
            while ($pos < $limit - 3) {
    ...
    public function __get($name)
    {
        if (method_exists($this, 'get' . ucfirst($name))) {
            ...
            require_once 'HausDesign/Media/Mpeg/Exception.php';
            throw new HausDesign_Media_Mpeg_Exception('Unknown field: ' . $name);
        }
    }
