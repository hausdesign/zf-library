...
require_once 'HausDesign/Media/Ogg/Page.php';
/**#@-*/

/**
 * This class is a HausDesign_Io_Reader specialization that can read a file containing the Ogg bitstream format version 0 as
 ...
 */
final class HausDesign_Media_Ogg_Reader extends HausDesign_Io_Reader
{
    /** @var Array */
    ...
    public function __construct($filename)
    {
        ...
        while ($reader->getOffset() < $fileSize) {
            $this->_pages[] = array(
                ...
                'page'   => $page = new HausDesign_Media_Ogg_Page($reader)
            );
     ...
     * @return HausDesign_Media_Ogg_Page
     */
