 ...
 * @version    $Id: Txxx.php 177 2010-03-09 13:13:34Z svollbehr $
 */
final class HausDesign_Media_Id3_Frame_Txxx extends HausDesign_Media_Id3_TextFrame
{
    /** @var string */
        ...
        switch ($this->_encoding) {
            case self::UTF16LE:
                $writer->writeString16
                    ($this->_description,
                     HausDesign_Io_Writer::LITTLE_ENDIAN_ORDER, null, 1)
                       ->writeString16
                    ($this->_text[0],
                     HausDesign_Io_Writer::LITTLE_ENDIAN_ORDER);
                break;
            case self::UTF16:
                // break intentionally omitted
            case self::UTF16BE:
