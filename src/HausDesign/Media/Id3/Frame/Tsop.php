 ...
 * instead of the {@link HausDesign_Media_Id3_Frame_Tpe2 TPE2} performer frame for
 * sorting purposes.
 *
 * @category   Zend
 * @package    HausDesign_Media
 ...
 * @since      ID3v2.4.0
 */
final class HausDesign_Media_Id3_Frame_Tsop extends HausDesign_Media_Id3_TextFrame
{}
