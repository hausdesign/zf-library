 ...
 * @deprecated ID3v2.3.0
 */
final class HausDesign_Media_Id3_Frame_Ipls extends HausDesign_Media_Id3_Frame
                ...
                switch ($this->_encoding) {
                    case self::UTF16LE:
                        $writer->writeString16
                            ($key, HausDesign_Io_Writer::LITTLE_ENDIAN_ORDER, 1)
                               ->writeString16
                            ($val, HausDesign_Io_Writer::LITTLE_ENDIAN_ORDER, 1);
                        break;
                    case self::UTF16:
                        // break intentionally omitted
                    case self::UTF16BE:
