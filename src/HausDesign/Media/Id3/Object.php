 ...
 * @version    $Id: Object.php 215 2011-04-30 10:37:09Z svollbehr $
 */
abstract class HausDesign_Media_Id3_Object
{
    /**
     * The reader object.
     *
    ...
    public function __get($name)
    {
        if (method_exists($this, 'get' . ucfirst($name))) {
            ...
            throw new HausDesign_Media_Id3_Exception('Unknown field: ' . $name);
        }
    }
     ...
     *
     * Character encoding sets can be {@link HausDesign_Media_Id3_Encoding}
     ...
     *
     * Character encoding set can be a {@link HausDesign_Media_Id3_Encoding}
    ...
    protected final function _translateIntToEncoding($encoding)
    {
        ...
        if (is_integer($encoding)) {
            switch ($encoding) {
                case HausDesign_Media_Id3_Encoding::UTF16:
                    return 'utf-16';
                case HausDesign_Media_Id3_Encoding::UTF16LE:
                    return 'utf-16le';
                case HausDesign_Media_Id3_Encoding::UTF16BE:
                    return 'utf-16be';
                case HausDesign_Media_Id3_Encoding::ISO88591:
                    return 'iso-8859-1';
                default:
                    return 'utf-8';
            }
     ...
     * already a {@link HausDesign_Media_Id3_Encoding} constant.
     *
     * @param string|integer $encoding The encoding.
     * @return integer
     */
    protected final function _translateEncodingToInt($encoding)
    {
        ...
        if (is_string($encoding)) {
            switch ($encoding) {
                case 'utf-16':
                    return HausDesign_Media_Id3_Encoding::UTF16;
                case 'utf-16le':
                    return HausDesign_Media_Id3_Encoding::UTF16;
                case 'utf-16be':
                    return HausDesign_Media_Id3_Encoding::UTF16BE;
                case 'iso-8859-1':
                    return HausDesign_Media_Id3_Encoding::ISO88591;
                default:
                    return HausDesign_Media_Id3_Encoding::UTF8;
            }
        }
        return HausDesign_Media_Id3_Encoding::UTF8;
    }
