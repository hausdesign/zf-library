 ...
 * @version    $Id: TextFrame.php 203 2010-10-14 05:42:20Z svollbehr $
 */
abstract class HausDesign_Media_Id3_TextFrame extends HausDesign_Media_Id3_Frame
    implements HausDesign_Media_Id3_Encoding
{
     ...
     * regardless if it was set using a {@link HausDesign_Media_Id3_Encoding} constant
     * or a string.
     * 
     * @return integer
     */
            ...
            case self::UTF16LE:
                ...
                for ($i = 0; $i < $count; $i++) {
                    $writer->writeString16
                        ($text, HausDesign_Io_Writer::LITTLE_ENDIAN_ORDER,
                         $i == $count ? null : 1);
                }
                break;
            case self::UTF16:
