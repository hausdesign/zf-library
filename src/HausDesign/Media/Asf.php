...
/**#@+ @ignore */
require_once 'HausDesign/Media/Asf/Object/Container.php';
/**#@-*/
 ...
 * @version    $Id: Asf.php 177 2010-03-09 13:13:34Z svollbehr $
 */
class HausDesign_Media_Asf extends HausDesign_Media_Asf_Object_Container
{
    /** @var string */
    private $_filename;
    ...
    public function __construct($filename, $options = array())
    {
        if ($filename instanceof HausDesign_Io_Reader) {
            ...
            try {
                ...
                throw new HausDesign_Media_Asf_Exception($e->getMessage());
            }
     ...
     *
     * @return HausDesign_Media_Asf_Object_Header
     */
     ...
     *
     * @return HausDesign_Media_Asf_Object_Data
     */
    ...
    public function write($filename)
    {
        ...
        $header->removeObjectsByIdentifier(HausDesign_Media_Asf_Object::PADDING);
        $header->headerExtension->removeObjectsByIdentifier
            (HausDesign_Media_Asf_Object::PADDING);
