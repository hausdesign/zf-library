 ...
 * @version    $Id: Flac.php 251 2011-06-13 15:41:51Z svollbehr $
 */
final class HausDesign_Media_Flac
{
    ...
    public function __call($name, $arguments)
    {
        ...
        require_once 'HausDesign/Media/Flac/Exception.php';
        throw new HausDesign_Media_Flac_Exception('Unknown metadata block: ' . strtoupper($name));
    }
    ...
    public function __get($name)
    {
        ...
        require_once 'HausDesign/Media/Flac/Exception.php';
        throw new HausDesign_Media_Flac_Exception('Unknown metadata block or field: ' . $name);
    }
    ...
    public function __set($name, $value)
    {
        if (method_exists($this, 'set' . ucfirst(strtolower($name)))) {
            ...
            require_once('HausDesign/Media/Flac/Exception.php');
            throw new HausDesign_Media_Flac_Exception('Unknown field: ' . $name);
        }
    }
}
