...
/**#@+ @ignore */
require_once 'HausDesign/Media/Riff/ContainerChunk.php';
/**#@-*/
 ...
 * @version    $Id: Riff.php 257 2012-01-26 05:30:58Z svollbehr $
 */
final class HausDesign_Media_Riff extends HausDesign_Media_Riff_ContainerChunk
{
    /** @var string */
     ...
     *
     * @param string|resource|HausDesign_Io_Reader $filename The path to the file, file descriptor of an opened file, or a
     *  {@link HausDesign_Io_Reader} instance.
     * @throws HausDesign_Media_Riff_Exception if given file descriptor is not valid or an error occurs in stream handling.
     */
    public function __construct($filename)
    {
        if ($filename instanceof HausDesign_Io_Reader) {
            ...
            try {
                ...
                throw new HausDesign_Media_Riff_Exception($e->getMessage());
            }
        }
