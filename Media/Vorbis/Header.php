 ...
 * @version    $Id: Header.php 239 2011-06-04 09:35:48Z svollbehr $
 */
abstract class HausDesign_Media_Vorbis_Header
{
    /**
     * The reader object.
     *
    ...
    public function __construct($reader)
    {
        ...
        if (!in_array($this->_packetType = $this->_reader->readUInt8(), array(1, 3, 5))) {
            ...
            throw new HausDesign_Media_Vorbis_Exception('Unknown header packet type: ' . $this->_packetType);
        }
        if (($vorbis = $this->_reader->read(6)) != 'vorbis') {
            require_once 'HausDesign/Media/Vorbis/Exception.php';
            throw new HausDesign_Media_Vorbis_Exception('Unknown header packet: ' . $vorbis);
        }
