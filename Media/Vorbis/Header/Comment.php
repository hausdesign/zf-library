...
/**#@+ @ignore */
require_once 'HausDesign/Media/Vorbis/Header.php';
/**#@-*/
 ...
 * @version    $Id: Comment.php 251 2011-06-13 15:41:51Z svollbehr $
 */
final class HausDesign_Media_Vorbis_Header_Comment extends HausDesign_Media_Vorbis_Header
{
    /** @var string */
    private $_vendor;
    ...
    public function __call($name, $arguments)
    {
        ...
        require_once 'HausDesign/Media/Vorbis/Exception.php';
        throw new HausDesign_Media_Vorbis_Exception('Unknown field: ' . strtoupper($name));
    }
