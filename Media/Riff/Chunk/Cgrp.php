 ...
 * {@link HausDesign_Media_Riff_Chunk_Ctoc CTOC} chunk. The CGRP chunk contains all the compound file elements, concatenated
 ...
 * the file format definition. Each element is identified by a corresponding {@link HausDesign_Media_Riff_Chunk_Ctoc CTOC}
 * table entry.
 *
 * @category   Zend
 * @package    HausDesign_Media
 ...
 * @todo       Implementation
 */
final class HausDesign_Media_Riff_Chunk_Cgrp extends HausDesign_Media_Riff_Chunk
{
    /**
