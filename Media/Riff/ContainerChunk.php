 ...
 * @version    $Id: ContainerChunk.php 257 2012-01-26 05:30:58Z svollbehr $
 */
abstract class HausDesign_Media_Riff_ContainerChunk extends HausDesign_Media_Riff_Chunk
{
    /** @var string */
    protected $_type;
    ...
    public function __construct($reader)
    {
        ...
        while (($this->_reader->getOffset() - $startOffset) < $this->_size) {
            ...
            if (@fopen
                    ($file = 'HausDesign/Media/Riff/Chunk/' .
    ...
    public function __get($name)
    {
        ...
        throw new HausDesign_Media_Riff_Exception('Unknown chunk/field: ' . $name);
    }
}
