...
/**#@+ @ignore */
require_once 'HausDesign/Bit/Twiddling.php';
 ...
 * @version    $Id: LameHeader.php 177 2010-03-09 13:13:34Z svollbehr $
 */
class HausDesign_Media_Mpeg_Abs_LameHeader extends HausDesign_Media_Mpeg_Abs_Object
{
    /** @var integer */
    ...
    public function __construct($reader, &$options = array())
    {
        ...
        $this->_radioReplayGain = array(
            'name' => HausDesign_Bit_Twiddling::getValue($tmp, 0, 2),
            'originator' => HausDesign_Bit_Twiddling::getValue($tmp, 3, 5),
            'absoluteGainAdjustment' =>
                HausDesign_Bit_Twiddling::getValue($tmp, 7, 15) / 10
        );
