...
/**#@+ @ignore */
require_once 'HausDesign/Media/Mpeg/Abs/Object.php';
require_once 'HausDesign/Media/Mpeg/Abs/Frame.php';
/**#@-*/
 ...
 */
final class HausDesign_Media_Mpeg_Abs extends HausDesign_Media_Mpeg_Abs_Object
{
    /** @var integer */
    private $_bytes;
    ...
    /** @var HausDesign_Media_Mpeg_Abs_XingHeader */
    private $_xingHeader = null;

    /** @var HausDesign_Media_Mpeg_Abs_LameHeader */
    private $_lameHeader = null;

    /** @var HausDesign_Media_Mpeg_Abs_VbriHeader */
    ...
    /**
     * Constructs the HausDesign_Media_Mpeg_ABS class with given file and options.
     *
    ...
    public function __construct($filename, $options = array())
    {
        ...
        while ($this->_reader->readString8(3) == 'ID3') {
            ...
            $header = new HausDesign_Media_Id3_Header($this->_reader);
            $this->_reader->skip
                ($header->getSize() +
                 ($header->hasFlag(HausDesign_Media_Id3_Header::FOOTER) ? 10 : 0));
            $offset = $this->_reader->getOffset();
        }
        $this->_reader->setOffset($offset);
            ...
            while ($this->_reader->getOffset() < $offset + 8 + $riffSize - 1) {
                ...
                if ($chunkId == 'fmt ') {
                    if ($this->_reader->readInt16LE() != 85) { // 85: MPEG-1 Layer 3 Codec
                        require_once 'HausDesign/Media/Mpeg/Exception.php';
                        throw new HausDesign_Media_Mpeg_Exception
        ...
        $this->_frames[] = $firstFrame =
            new HausDesign_Media_Mpeg_Abs_Frame($this->_reader, $options);
        ...
        if (($xing = $this->_reader->readString8(4)) == 'Xing' ||
                $xing == 'Info') {
            require_once 'HausDesign/Media/Mpeg/Abs/XingHeader.php';
            $this->_xingHeader =
                new HausDesign_Media_Mpeg_Abs_XingHeader($this->_reader, $options);
            if ($this->_reader->readString8(4) == 'LAME') {
                require_once 'HausDesign/Media/Mpeg/Abs/LameHeader.php';
                $this->_lameHeader =
                    new HausDesign_Media_Mpeg_Abs_LameHeader
        ...
        if ($this->_reader->readString8(4) == 'VBRI') {
            require_once 'HausDesign/Media/Mpeg/Abs/VbriHeader.php';
            $this->_vbriHeader =
                new HausDesign_Media_Mpeg_Abs_VbriHeader($this->_reader, $options);
     ...
     * bitstream.
     *
     * @return HausDesign_Media_Mpeg_Abs_XingHeader
     */
     ...
     * bitstream.
     *
     * @return HausDesign_Media_Mpeg_Abs_LameHeader
     */
     ...
     * the audio bitstream.
     *
     * @return HausDesign_Media_Mpeg_Abs_VbriHeader
     */
    ...
    private function _readFrames($limit = null)
    {
        ...
        for ($i = 0; ($j = $this->_reader->getOffset()) < $this->_bytes; $i++) {
            ...
            $frame = new HausDesign_Media_Mpeg_Abs_Frame($this->_reader, $options);
