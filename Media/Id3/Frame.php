 ...
 * @version    $Id: Frame.php 215 2011-04-30 10:37:09Z svollbehr $
 */
abstract class HausDesign_Media_Id3_Frame extends HausDesign_Media_Id3_Object
{
    /**
     ...
     * frame. See description of the {@link HausDesign_Media_Id3_Frame_Encr ENCR}
    ...
    public function __construct($reader = null, &$options = array())
    {
        ...
        if ($reader === null) {
            ...
            $this->_reader = new HausDesign_Io_StringReader($data);
        }
    }
