 ...
 * {@link HausDesign_Media_Id3_Frame_Tlen TLEN} frame, indicating the duration of the
 ...
 * @since      ID3v2.4.0
 */
final class HausDesign_Media_Id3_Frame_Aspi extends HausDesign_Media_Id3_Frame
{
    /** @var integer */
    private $_dataStart;
