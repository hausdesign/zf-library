 ...
 * the {@link HausDesign_Media_Id3_Frame_Talb TALB} frame is divided into several
 ...
 * @version    $Id: Tpos.php 177 2010-03-09 13:13:34Z svollbehr $
 */
final class HausDesign_Media_Id3_Frame_Tpos extends HausDesign_Media_Id3_TextFrame
{
    private $_number;
    private $_total;
    ...
    public function setNumber($part)
    {
        $this->setText
            ($this->_number = strval($part) .
             ...
             HausDesign_Media_Id3_Encoding::ISO88591);
    }
