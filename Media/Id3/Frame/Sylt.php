 ...
 * @version    $Id: Sylt.php 255 2012-01-21 19:46:18Z svollbehr $
 */

/**#@+ @ignore */
require_once 'HausDesign/Media/Id3/Frame.php';
require_once 'HausDesign/Media/Id3/Encoding.php';
require_once 'HausDesign/Media/Id3/Language.php';
require_once 'HausDesign/Media/Id3/Timing.php';
/**#@-*/
 ...
 * @version    $Id: Sylt.php 255 2012-01-21 19:46:18Z svollbehr $
 */
final class HausDesign_Media_Id3_Frame_SYLT extends HausDesign_Media_Id3_Frame
    implements HausDesign_Media_Id3_Encoding, HausDesign_Media_Id3_Language,
        HausDesign_Media_Id3_Timing
{
    /**
    ...
    /** @var integer */
    private $_format = HausDesign_Media_Id3_Timing::MPEG_FRAMES;
    ...
    public function __construct($reader = null, &$options = array())
    {
        ...
        $this->setEncoding
            ($this->getOption('encoding', HausDesign_Media_Id3_Encoding::UTF8));
     ...
     * {@link HausDesign_Media_Id3v2} for details. This method returns that character
     * encoding, or any value set after read, translated into a string form
     * regarless if it was set using a {@link HausDesign_Media_Id3_Encoding} constant
     * or a string.
     *
     * @return integer
     */
     ...
     * {@link HausDesign_Media_Id3_Encoding} constant or a character set name string
     * in the form accepted by iconv. The default character encoding used to
     * write the frame is 'utf-8'.
     *
     * @see HausDesign_Media_Id3_Encoding
     ...
     * {@link http://www.loc.gov/standards/iso639-2/ ISO-639-2} standard.
     *
     * @see HausDesign_Media_Id3_Language
     ...
     *
     * @see HausDesign_Media_Id3_Timing
    ...
    protected function _writeData($writer)
    {
        ...
        switch ($this->_encoding) {
            case self::UTF16LE:
                $writer->writeString16
                    ($this->_description,
                     HausDesign_Io_Writer::LITTLE_ENDIAN_ORDER, 1);
                break;
            case self::UTF16:
                // break intentionally omitted
            case self::UTF16BE:
        ...
        foreach ($this->_events as $timestamp => $syllable) {
            switch ($this->_encoding) {
                case self::UTF16LE:
                    $writer->writeString16
                        ($syllable, HausDesign_Io_Writer::LITTLE_ENDIAN_ORDER, 1);
                    break;
                case self::UTF16:
                    // break intentionally omitted
                case self::UTF16BE:
