 ...
 * or, if signed, as proof. Note that the {@link HausDesign_Media_Id3_Frame_User USER}
 * and {@link HausDesign_Media_Id3_Frame_Town TOWN} frames are good to use in
 ...
 * @version    $Id: Owne.php 177 2010-03-09 13:13:34Z svollbehr $
 */
final class HausDesign_Media_Id3_Frame_Owne extends HausDesign_Media_Id3_Frame
    implements HausDesign_Media_Id3_Encoding
{
    /** @var integer */
    private $_encoding;
        ...
        switch ($this->_encoding) {
            case self::UTF16LE:
                $writer->writeString16
                    ($this->_seller, HausDesign_Io_Writer::LITTLE_ENDIAN_ORDER);
                break;
            case self::UTF16:
