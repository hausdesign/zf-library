 ...
 * @version    $Id: ExtendedStreamProperties.php 177 2010-03-09 13:13:34Z svollbehr $
 */
final class HausDesign_Media_Asf_Object_ExtendedStreamProperties
    extends HausDesign_Media_Asf_Object
{
    ...
    public function write($writer)
    {
        ...
        $streamNameWriter = new HausDesign_Io_StringWriter();
        for ($i = 0; $i < $streamNameCount; $i++) {
            $streamNameWriter
        ...
        $payloadExtensionSystemWriter = new HausDesign_Io_StringWriter();
        for ($i = 0; $i < $payloadExtensionSystemCount; $i++) {
