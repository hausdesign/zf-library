 ...
 * <i>{@link HausDesign_Media_Asf_Object_Metadata Metadata Object}</i>, as well as
 ...
 * @version    $Id: MetadataLibrary.php 177 2010-03-09 13:13:34Z svollbehr $
 */
final class HausDesign_Media_Asf_Object_MetadataLibrary extends HausDesign_Media_Asf_Object
{
    /** @var Array */
    ...
    public function write($writer)
    {
        ...
        $descriptionRecordsWriter = new HausDesign_Io_StringWriter();
        for ($i = 0; $i < $descriptionRecordsCount; $i++) {
