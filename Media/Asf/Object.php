 ...
 * @version    $Id: Object.php 177 2010-03-09 13:13:34Z svollbehr $
 */
abstract class HausDesign_Media_Asf_Object
{
    /* ASF Objects */
    ...
    /** @var HausDesign_Media_Asf_Object */
    ...
    /**
     * Sets the options array. See {@link HausDesign_Media_Asf} class for available
     * options.
     *
     * @param Array $options The options array.
     */
     ...
     *
     * @param HausDesign_Media_Asf_Object $parent The parent object.
     */
    ...
    public function __get($name)
    {
        ...
        require_once 'HausDesign/Media/Asf/Exception.php';
        throw new HausDesign_Media_Asf_Exception('Unknown field: ' . $name);
    }
