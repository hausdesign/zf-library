<?php
class HausDesign_Form_Decorator_FormWrapper extends Zend_Form_Decorator_Abstract
{
    /**
    ...
    public function render($content)
    {
        ...
        if (!$noAttribs) {
            ...
            if (null !== ($element = $this->getElement())) {
                $attribsElement = $element->getAttribs();
                $attribs = array_merge($attribsElement, $attribs);
            }
        }
