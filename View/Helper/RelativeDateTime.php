 ...
 *
 * @category    HausDesign
 * @package     HausDesign\View
 * @subpackage  Helper
 * @author      Boris Guéry <guery.b@gmail.com>
 * @license     http://sam.zoy.org/wtfpl/COPYING
 * @link        http://borisguery.github.com/HausDesignlibrary
 */

require_once 'Zend/View/Helper/Abstract.php';

class HausDesign_View_Helper_RelativeDateTime extends Zend_View_Helper_Abstract
{
    const YEAR = 'YEAR';
    const MONTH = 'MONTH';
    const WEEK = 'WEEK';
    ...
    public function setUnitTemplate($unitKey, $template)
    {
        if (!isset($this->_unitTemplates[$unitKey])) {
            require_once 'HausDesign/View/Helper/Exception.php';
            throw new HausDesign_View_Helper_Exception("No unit template exists for key '$unitKey'");
        }
